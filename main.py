...
async def news_command(ctx):
    ...
    embed = discord.Embed(
        title="📰 أخبار",
        description="استخدم `/ai` لتوفير أخبار محدثة",
...
class GameView(discord.ui.View):
    ...
    async def rps_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.response.send_message(f"البوت اختار: {bot_choice}", ephemeral=True)
    ...
    async def guess_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.response.send_message(f"🎯 خمن رقم من 1 إلى 100!", ephemeral=True)
